...
var societyCmd = &cobra.Command{
	Use:   "society",
	Short: "society application",
	Long:  "society application",
	Args:  cobra.ExactArgs(0),
	RunE: func(cmd *cobra.Command, args []string) error {
...
func cmdSociety(cmd *cobra.Command, args []string) error {
	...
	if flagPersist == "" {
		app = abci_app.NewKVStoreApplication()
	} else {
		app = abci_app.NewPersistentKVStoreApplication(flagPersist)
		app.(*abci_app.PersistentKVStoreApplication).SetLogger(logger.With("module", "kvstore"))
	}
